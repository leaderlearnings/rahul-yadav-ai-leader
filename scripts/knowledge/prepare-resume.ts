/**
 * scripts/knowledge/prepare-resume.ts
 *
 * Prepares the "resume" document type: work history, education, certifications,
 * awards and other leadership experience.
 *
